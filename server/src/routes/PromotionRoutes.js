...
router.get('/usableByUserId/:id', authMiddleware([UserRole.Staff, UserRole.Manager, UserRole.Customer], UserRole.Customer),promotionController.usablePromotionsByUserId_get)

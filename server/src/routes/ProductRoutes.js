...
router.get(
  "/getBySubCategoryWithPromotions/:id",
  productController.productsAndPromotionsBySubCategory_get
);
router.get(
  "/:id/getDetailsWithPromotions/",
  productController.detailsWithPromotionById_get
);
router.get(
  "/:id/getSimilarProductsWithPromotions",
  productController.getSimilarProductsWithPromotions
);

...
import AddEmployee from "../pages/employee/EmployeeManagement/AddEmployee";
  ...
  return (
    <Routes>
      ...
      <Route path={Urls.ADMIN.SUPPLIES.BASE.Route}>
        ...
        <Route
          path={Urls.ADMIN.SUPPLIES.IMPORTS.BASE.Route}
          element={<ImportList />}
        />
        <Route
          path={Urls.ADMIN.SUPPLIES.IMPORTS.ADD.Route}
          element={<AddImport />}
        />
        <Route
          path={Urls.ADMIN.SUPPLIES.IMPORTS.EDIT.Route}
          element={<EditImport />}
        />
      </Route>
      ...
      <Route path={Urls.ADMIN.PROMOTIONS.BASE.Route}>
        ...
        <Route
          path={Urls.ADMIN.PROMOTIONS.ADD.Route}
          element={<AddPromotion />}
        />
        <Route
          path={Urls.ADMIN.PROMOTIONS.EDIT.Route}
      ...
      <Route
        path={Urls.ADMIN.CUSTOMERS.Route}
      ...
      <Route path={Urls.ADMIN.EMPLOYEE.BASE.Route}>
        ...
        <Route
          path={Urls.ADMIN.EMPLOYEE.ADD.Route}
          element={<AddEmployee/>}/>
        <Route

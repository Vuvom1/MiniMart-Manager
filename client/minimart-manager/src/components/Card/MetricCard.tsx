        ...
        <div className="flex justify-between bg-white rounded-lg p-6 shadow-lg h-full w-full">
            <div className="flex flex-col justify-between ">
                ...
                <div className="flex items-center mt-2 gap-x-2">
                    <div className={`flex ${(isPositive && typeof percentage === 'number' && percentage > 0) ? 'text-green-500' : 'text-red-500'}`}>
                        ...
                        <span className="text-sm font-medium">{typeof percentage === 'number' ? percentage.toFixed(2) : percentage}%</span>
                    </div>

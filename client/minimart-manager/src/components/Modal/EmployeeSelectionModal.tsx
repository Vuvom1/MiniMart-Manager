...
import { employeeStatusColorMapping } from '../../constant/mapping';
                            ...
                            >
                                <div className='flex justify-between items-center w-full'>
                                    <div className='flex gap-x-4'>
                                        <Avatar size='50px' src={employee.user.image} />
                                        <div>
                                            <h3 className="font-medium text-gray-600">{employee.user.firstname} {employee.user.lastname}</h3>
                                            <p className="text-gray-400">{employee.user.email}</p>
                                            
                                        </div>
                                    </div>
                                    <div>
                                    <StatusBadge value={employee.user.role} mapping={employeeStatusColorMapping} />
                                    </div>

...
const EditEventModal: React.FC<EditEventModalProps> = ({ shift, scheduleId, onClose }) => {
                    ...
                    <div className="bg-white rounded-md p-4 max-w-2xl w-full px-6">
                        ...
                        <div className="flex flex-col gap-6 overflow-y-auto my-4">
                            ...
                            <div className='flex gap-x-4 items-center'>
                                ...
                                <DateField width='25%' onChange={(e) => setDate(e.target.value)} value={date} />
                                <TimeField width='20%' value={startTime} onChange={(e) => setStartTime(e.target.value)} />
                                <TimeField width='20%' value={endTime} onChange={(e) => setEndTime(e.target.value)} />

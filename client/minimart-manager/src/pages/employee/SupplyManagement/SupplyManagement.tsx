...
function SupplyManagement() {
  ...
  const [importsStatistic, setImportsStatistic] =
    useState<ImportsStatistic | null>(null);
  ...
  const doughnutChartData = {
    labels: importsStatistic?.statisticByCategory.map(
      (category) => category._id
    ),
    values: importsStatistic?.statisticByCategory.map(
      (category) => category.totalImportedProduct
    ),
  };
      ...
      <div className="gap-y-4 grid">
        <div className="flex gap-x-4">
          <MetricCard
            ...
            value={
              period == Period.DAILY
                ? importsStatistic?.statisticByDate.todayImports
                : period == Period.MONTHLY
                ? importsStatistic?.statisticByMonth.thisMonthImports
                : importsStatistic?.statisticByYear.thisYearImports
            }
            percentage={
              period == Period.DAILY
                ? importsStatistic?.statisticByDate.percentageCompareYesterday
                : period == Period.MONTHLY
                ? importsStatistic?.statisticByMonth.percentageCompareLastMonth
                : importsStatistic?.statisticByYear.percentageCompareLastYear
            }
            icon={
              <svg
          ...
          <MetricCard
            ...
            value={
              period == Period.DAILY
                ? importsStatistic?.statisticByDate.todayImportedProducts
                : period == Period.MONTHLY
                ? importsStatistic?.statisticByMonth.thisMonthImportedProducts
                : importsStatistic?.statisticByYear.thisYearImportedProducts
            }
            percentage={
              period == Period.DAILY
                ? importsStatistic?.statisticByDate.percentageCompareYesterday
          ...
          <MetricCard
            ...
            value={
              period == Period.DAILY
                ? suppliersStatistic?.statisticByDate.todaySuppliers
                : period == Period.MONTHLY
                ? suppliersStatistic?.statisticByMonth.thisMonthSuppliers
                : suppliersStatistic?.statisticByYear.thisYearSuppliers
            }
            percentage={
              period == Period.DAILY
                ? suppliersStatistic?.statisticByDate.percentageCompareYesterday
                : period == Period.MONTHLY
                ? suppliersStatistic?.statisticByMonth
                    .percentageCompareLastMonth
                : suppliersStatistic?.statisticByYear.percentageCompareLastYear
            }
            icon={
              <svg
                xmlns="http://www.w3.org/2000/svg"

            ...
            <div className="flex gap-4 h-full w-full mb-4">
                <div className="flex flex-col gap-y-6 p-4 bg-white w-1/2 rounded-lg">
                    ...
                    <div className="flex gap-x-6 px-4 items-center">
                        ...
                        <DatePicker value={promotion.startDate} onChange={(value) => handleChangePromotionData("startDate", value)} width="25%" />
                        <TimeField value={promotion.startTime} onChange={(e) => handleChangePromotionData("startTime", e.target.value)} width="23%" />
                    </div>
                    <div className="flex gap-x-6 px-4 items-center">
                        <p className="w-[20%] text-sm font-medium leading-6 text-gray-900">End Time</p>
                        <DatePicker value={promotion.endDate} onChange={(value) => handleChangePromotionData("endDate", value)} width="25%" />
                        <TimeField value={promotion.endTime} onChange={(e) => handleChangePromotionData("endTime", e.target.value)} width="23%" />
                    </div>
                    <div className="flex gap-x-6 px-4 items-center">
                    ...
                    <div className="flex gap-x-6 px-4 items-center">
                        <TextField value={promotion.description} multiline={true} rows={5} onChange={(e) => handleChangePromotionData("description", e.target.value)} label="Description" height="200px" placeholder="Promotion description (Optional)" />
                    </div>
                </div>
                <div className="flex flex-col gap-y-6 p-4 bg-white w-1/2 rounded-lg">
                    <div>
                            ...
                            (
                                <>
                                    <div className="flex gap-x-4 items-center">
                                        ...
                                        <IncrementalField initialValue={0} onQuantityChange={(value) => handleChangePromotionData("requiredQuantity", value)} />
                                    </div>
                                    <div className="flex gap-x-4 items-center">
                                        <p className="text-sm font-semibold text-gray-800 w-[30%]">Reward quantity</p>
                                        <IncrementalField initialValue={0} onQuantityChange={(value) => handleChangePromotionData("rewardQuantity", value)} />
                                    </div>
                                </>
                            )
                        }
...

                        {
                            ...
                            (
                                <>{
                                    ...
                                    <div className="flex gap-x-4 items-center">
                                        <p className="text-sm font-semibold text-gray-800 w-[30%]">Require quantity</p>
                                        <IncrementalField onQuantityChange={(value) => handleChangePromotionData("rewardQuantity", value)} />
                                    </div>
                                }

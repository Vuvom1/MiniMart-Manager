...
function SideMenu() {
    ...
    const menuItems = [
        { label: 'Dashboard', icon: <DashboardIcon />, path: Urls.ADMIN.DASHBOARD.Path },
    ...
    useEffect(() => {
        ...
        const currentIndex = menuItems.findIndex(item => item.path === currentPath.match(/\/admin\/\w+/)?.[0]);
